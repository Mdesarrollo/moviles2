                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(labelText: "Apelido uno"),
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(labelText: "Apellido Dos"),
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items: const [
                          DropdownMenuItem(
                            value: "M",
                            child: Text("Masculino (M)"),
                          ),
                          DropdownMenuItem(
                            value: "F",
                            child: Text("Femenino (F)"),
                          ),
                          DropdownMenuItem(
                            value: "O",
                            child: Text("Terreneitor (O)"),
                          ),
                        ],
